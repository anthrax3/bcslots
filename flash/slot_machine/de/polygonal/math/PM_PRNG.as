...
class de.polygonal.math.PM_PRNG
{
	 ...
	 */
	public function nextInt():Number
	{
		return gen();
	}
	 ...
	 * a given range.
	 */
	public function nextIntRange(min:Number, max:Number):Number
	{
		min -= .4999;
		max += .4999;
	...
	private function gen():Number
	{
		 ...
		 */
		//var hi:Number = 16807 * (seed >> 16);
		//var lo:Number = 16807 * (seed & 0xFFFF) + ((hi & 0x7FFF) << 16) + (hi >> 15);
